...
public class MqMessageServiceImpl extends ServiceImpl<MqMessageMapper, MqMessage> implements MqMessageService {
    ...
    public int getStageOne(long id) {
        Integer stageState1 = Integer.valueOf(mqMessageMapper.selectById(id).getStageState1());
        return stageState1 != null ? stageState1.intValue() : 0;
    }

    @Override
    public int getStageTwo(long id) {
        Integer stageState2 = Integer.valueOf(mqMessageMapper.selectById(id).getStageState2());
        return stageState2 != null ? stageState2.intValue() : 0;

    }

    @Override
    public int getStageThree(long id) {
        Integer stageState3 = Integer.valueOf(mqMessageMapper.selectById(id).getStageState3());
        return stageState3 != null ? stageState3.intValue() : 0;
    }

    @Override
    public int getStageFour(long id) {
        Integer stageState4 = Integer.valueOf(mqMessageMapper.selectById(id).getStageState4());
        return stageState4 != null ? stageState4.intValue() : 0;
    }
