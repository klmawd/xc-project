...
public class CourseIndexSearchTest {
    ...
    public void test_addindex() {
        ...
        Boolean result = courseIndexService.addCourseIndex(courseIndexStore, "189", courseIndex);
    ...
    public void test_deleteIndex(){
        courseIndexService.deleteCourseIndex(courseIndexStore,"101");
    }
}
